/* ============================================================
   ...
   Colunas idênticas às da v2 (o campo versao_modelo distingue as linhas
   de cada versão) — dá para reaproveitar a planilha da v2 ou criar uma
   nova, como preferir. Instruções de deploy iguais às da v1 — ver
   ../../teste-piloto/apps-script/README.md
   ============================================================ */
